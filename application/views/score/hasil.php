        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <form action="<?= base_url('kelas1/cari'); ?>" method="get">
                        <div class="col-xs-2">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($score as $sc) : ?>
                                <tr>
                                    ...
                                    <td><?= $sc['result']; ?></td>
                                    <td>
                                        <a data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-adn" href=""><i class="fa fa-edit"></i></a>
                                        <a data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-adn" onclick="return confirm('are you sure?');" href=""><i class="fa fa-trash"></i></a>
